...
Object.defineProperties( module.exports = Abstract, {
  ...
  createModel: {
    ...
    value: function createModel( Model ) {
      ...
      Abstract.defineProperties( Model, {
        use: { value: Abstract.prototype.use.bind( Model ), enumerable: false },
        require: { value: Abstract.prototype.require.bind( Model ), enumerable: false },
        get: { value: Abstract.prototype.get.bind( Model ), enumerable: false },
        set: { value: Abstract.prototype.set.bind( Model ), enumerable: false },
        properties: { value: Abstract.prototype.properties.bind( Model ), enumerable: false },
        defineInstance: { value: Abstract.defineInstance.bind( Model, Model ), enumerable: false },
        defineConstructor: { value: Abstract.defineConstructor.bind( Model, Model ), enumerable: false },
        defineProperties: { value: Abstract.defineProperties.bind( Model ), enumerable: false },
        defineProperty: { value: Abstract.defineProperty.bind( Model ), enumerable: false }
      });
      ...
      if( Model.instantiator && Object.keys( Model.instantiator ).length ) {
        Model.instantiator.forEach( function( fn ) { _custom_name = fn.name || _custom_name; });
      }
  ...
  defineConstructor: {
    ...
    value: function defineConstructor( target, fn ) {
      ...
      Object.defineProperty( target, 'instantiator', {
  ...
  require: {
    ...
    value: function use( source ) {
      ...
      if( 'string' === typeof source ) {
        ...
        } catch( error ) { source = source || null }
      }
