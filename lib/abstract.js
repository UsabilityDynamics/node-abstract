  ...
  createModel: {
    ...
    value: function createModel( Model ) {
      ...
      Abstract.defineProperties( Model, {
        ...
        defineProperties: Abstract.defineProperties.bind( Model, Model ),
        defineProperty: Abstract.defineProperty.bind( Model, Model )
      });
      ...
      Model.create = function Instantiator() {
        ...
        for( var key in Model.__proto__ ) {
          Object.defineProperty( Instance, key, {
            value: Model.__proto__[key], enumerable: false, writable: true, configurable: true
          });
        }
        ...
        if( this.instantiator && Object.keys( this.instantiator ).length ) {
          this.instantiator.forEach( function( fn ) { fn.apply( Instance, arguments ); });
        }
