...
Object.defineProperties(module.exports = Utility, {json: {value: {parse: (function (json) {
  ...
  for (var i = 0; i < array.length; i++) {
    _$jscoverage['utility.js'][503]++;
    if (b.indexOf(array[i]) == -1) {
      _$jscoverage['utility.js'][503]++;
      b.push(array[i]);
    }
}
  _$jscoverage['utility.js'][505]++;
  return b;
  ...
  _$jscoverage['utility.js'][537]++;
  try {
    _$jscoverage['utility.js'][539]++;
    if (options.random) {
      _$jscoverage['utility.js'][540]++;
